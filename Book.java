...
public class Book {
    ...
    public Book(String title, String author, String isbn) {  // USING Constructor
        this.title = title;
    ...
    public static void addBook(Book[] collection, Book book, int index) {       // Method for add  book 
        collection[index] = book;
        System.out.println("Book added: " + book.getTitle());
    }

        public static void removeBook(Book[] collection, String isbn, int index) {     // Method for remove  book 
    ...
    public static void main(String[] args) {
        ...
        Book[] collection = new Book[10];      // Create  array to store books
            ...
            switch (choice) {
                case 1:
                    if (bookCount < collection.length) {
                        ...
                        addBook(collection, new Book(title, author, isbn), bookCount++);
                    } else {
